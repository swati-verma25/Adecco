...
using Adecco.WebApi.GlobalErrorHandling;
using Adecco.Http;
namespace Adecco.WebApi
{
    /// <summary>
    /// Owin Start up file
    /// </summary>
    public class Startup
    {
        ...
        {
            services.AddTransient<IAdeccoRepository, AdeccoRepository>();
            services.AddTransient<IAdeccoBusinessLogic, AdeccoBusinessLogic>();
        }
